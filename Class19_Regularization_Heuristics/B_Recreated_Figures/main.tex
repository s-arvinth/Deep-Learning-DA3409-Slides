...
\graphicspath{{figs/}{Class19_Regularization_Heuristics/B_Recreated_Figures/figs/}}
...
\begin{frame}{The two filters, measured}
  \begin{center}
    \includegraphics[width=0.72\linewidth]{early_vs_decay}
  \end{center}
  \vspace{-0.3em}
  \figcap[0.97]{(a) the two filters at three run lengths and their
  matched penalties; each pair crosses over together. (b) directions
  left alive, over a spectrum of $120$ eigenvalues: the two never differ
  by more than $7\%$ of $W$.}
\end{frame}
