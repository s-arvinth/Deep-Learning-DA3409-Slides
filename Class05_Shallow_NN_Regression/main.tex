% =====================================================================
%  Fundamentals of Deep Learning — Class 5 (3 August)
...
\usepackage{graphicx}
\graphicspath{{Class05_Shallow_NN_Regression/figs_official/}{figs_official/}}
...
\author{Fundamentals of Deep Learning \ \textperiodcentered\ Class 5
  ...
  \begin{columns}[T, onlytextwidth]
    ...
    \begin{column}{0.38\textwidth}
      ...
      \begin{itemize}\setlength{\itemsep}{1pt}
        ...
        \item {\small Existence --- not a recipe, not a
