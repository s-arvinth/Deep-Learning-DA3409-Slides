% =====================================================================
%  Introduction to Deep Learning — Class 6 (4 August)
...
\author{Introduction to Deep Learning \ \textperiodcentered\ Class 6
...
\begin{frame}{Where the loss function comes from}
...
\begin{frame}{Why not squared error on probabilities?}
  ...
  \begin{itemize}\setlength{\itemsep}{1pt}
    ...
    \item The principle at work: \alert{match the
