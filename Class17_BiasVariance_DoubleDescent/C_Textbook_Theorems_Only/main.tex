...
%
%  C variant: the B deck with every result absent from both textbooks
%  removed.  Gone are the closed-form ridgeless risk of Hastie et al.
%  (2022), its two-branch reading, the norm-blow-up mechanism, and the
%  sample-wise curve derived from it.
...
\graphicspath{{figs/}{Class17_BiasVariance_DoubleDescent/C_Textbook_Theorems_Only/figs/}}
...
\begin{frame}{Takeaways}
  ...
  \begin{enumerate}\itemsep0.34em
    ...
    \item Below the interpolation threshold the classical U-curve is
          real and measurable
    \item Past the threshold a whole family of exact fits exists, and
          which one the algorithm returns is what decides the test error
