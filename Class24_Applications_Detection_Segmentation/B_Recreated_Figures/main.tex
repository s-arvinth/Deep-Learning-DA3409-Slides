...
\graphicspath{{figs/}{Class24_Applications_Detection_Segmentation/B_Recreated_Figures/figs/}}
...
\begin{frame}{The Progress of the field}
  \begin{center}
...
\begin{frame}{Scoring a box}
  ...
  \end{defx}
  \vspace{-0.3em}
  \begin{propx}[What is the advantage of the ratio?]\label{th:iouprop}
    \small
...
\begin{frame}{What the bottleneck discards}
  ...
  brought back by bilinear up-sampling: the error grows with depth,
  and the thin line is gone by the second level.}
\end{frame}
