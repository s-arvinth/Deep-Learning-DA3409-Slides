...
%  deck with those three removed.  See _shared/PLAN_Classes23_24_25.md.
%
...
\graphicspath{{figs/}{Class25_Convolution_Filters_Learned/B_Recreated_Figures/figs/}}
...
\begin{frame}{Composition, computed}
  ...
  two, the result differs from any single kernel: the difference has an
...
\begin{frame}{The attack, run}
  ...
  against $\epsilon$, to chance by $0.05$; $\|\mathbf{w}\|_1 = 86$, so
  that $\epsilon$ moves the activation by $4.3$.
